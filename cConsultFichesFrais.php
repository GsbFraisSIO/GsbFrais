...
<?php          
  ...
  ?>
    ...
    $sql = "select libelle FROM fichefrais ff inner join etat e on e.id = ff.idEtat where idVisiteur = '" .obtenirIdUserConnecte(). "'";
    $result = mysqli_query($idConnexion, $sql);
    $row = mysqli_fetch_assoc($result);
    echo "Etat fiche de frais : ".$row['libelle']; ?></p>
